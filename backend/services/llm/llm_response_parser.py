...
def clean_training_data_leakage(text: str, prompt: Optional[str] = None) -> str:
    ...
    if prompt and len(prompt) > 100:
        ...
        mid_prompt_fragments = [
            # Common mid-sentence fragments from instruction prompts
            "ues or unnecessary",
            ...
            # Context/classification artifacts
            "context information",
            "ontext information",
            "ntext information",
            "text information",
            ...
            "le in the",
            "e in the context",
            # NEW: Additional fragments commonly seen in weather/training data leakage
            "weather data",
            "training data",
            "example response",
            "sample response",
            ...
            "AI should",
            "bot should",
            # More fragmented instruction patterns
            "nformation about",
            "formation about",
            "ormation about",
            "rmation about",
        ...
        for fragment in mid_prompt_fragments:
            if stripped_text.lower().startswith(fragment.lower()):
    ...
    if detected_lang in ['Russian', 'Arabic']:
        ...
        "\nREMEMBER: Answer in",
        "\n⚠️ CRITICAL:",
        # Training data Q&A patterns
        "\nNote: If the question was in Turkish",
        "\n\nNote: If the question was in Turkish",
        " Note: If the question was in Turkish",
        "\nAnswer Choices:",
        "\n\nAnswer Choices:",
        ...
        "IMPORTANT:",
        "\n**Context information available:**",
        # Meta-commentary and self-referential notes that LLM adds
        "\n\n(Note:",
        "\n(Note:",
        " (Note:",
        "\n\nIn this case,",
        ...
        " to match the language of the question",
        "\n\nYou can use the context",
        "\nYou can use the context",
        " You can use the context",
        # Additional meta-commentary patterns
        ...
        # Multilingual examples the LLM generates
        " (in English)",
        " (in French)",
        " (in Turkish)",
        " (in Spanish)",
