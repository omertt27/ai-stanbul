...
const SocialShareButtons = ({ 
  ...
  title, 
  description,
  hashtags = ['Istanbul', 'Travel', 'AIIstanbul'],
  className = ''
}) => {
    ...
    <div className={`social-share-buttons ${className}`}>
      <div className="flex flex-wrap gap-2 items-center">
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-lg transition-colors duration-200"
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-green-500 hover:bg-green-600 rounded-lg transition-colors duration-200"
        ...
        <button
          ...
          id="copy-link-btn"
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-lg transition-colors duration-200"
          title="Copy link"
        >
