    ...
    <div className={`min-h-screen pt-20 sm:pt-28 md:pt-36 px-2 sm:px-4 pb-8 transition-colors duration-200 ${
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8 mt-2 sm:mt-4 px-2">
          <p className={`text-base sm:text-lg md:text-xl max-w-3xl mx-auto mb-4 sm:mb-6 transition-colors duration-200 ${
          ...
          <Link
            to="/blog/new"
            className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition-colors duration-200 text-sm sm:text-base"
          >
        ...
        {/* Search and Filters */}
        <div className={`mb-6 sm:mb-8 rounded-lg p-4 sm:p-6 transition-colors duration-200 relative ${
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <div className="flex-1">
                ...
                <input
                  ...
                  className={`w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg focus:outline-none transition-colors duration-200 text-sm sm:text-base ${
                    darkMode 
              ...
              <button
                type="submit"
                className={`px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-colors duration-200 whitespace-nowrap text-sm sm:text-base ${
                  darkMode
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:gap-4">
            ...
            {(searchTerm || selectedDistrict) && (
              <button
                ...
                className={`px-3 sm:px-4 py-2 sm:py-3 rounded-lg font-medium transition-colors duration-200 whitespace-nowrap text-sm sm:text-base ${
                  darkMode
        ...
        {posts.length === 0 && !loading && !error ? (
          ...
          <>
            <div className="text-center mb-4">
              <p className="text-sm text-gray-500">Found {posts.length} posts</p> {/* Debug info */}
            </div>
                ...
                <div className="p-4 sm:p-6">
                  ...
                  {post.author_name && (
                    <div className="flex items-center mb-3">
                      ...
                      <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full mr-2 sm:mr-3 bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-xs sm:text-sm font-semibold ${post.author_photo ? 'hidden' : ''}`}>
                  ...
                  <h2 className={`text-lg sm:text-xl font-bold mb-2 leading-tight transition-colors duration-200 ${
                    darkMode 
                  ...
                  <p className={`mb-3 sm:mb-4 text-sm sm:text-base leading-relaxed transition-colors duration-200 ${
                    darkMode ? 'text-gray-300' : 'text-gray-600'
                  }`}>
                    {truncateText(post.content, window.innerWidth < 640 ? 100 : 150)}
                  </p>
                  
                  <div className={`flex items-center justify-between text-xs sm:text-sm transition-colors duration-200 ${
                    darkMode ? 'text-gray-400' : 'text-gray-500'
                  }`}>
                    <div className="flex items-center">
                      ...
                      <span className="truncate">{post.district || 'Istanbul'}</span>
                    </div>
